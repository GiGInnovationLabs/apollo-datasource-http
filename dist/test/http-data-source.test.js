...
(0, ava_1.default)('Should be able to decode gzip compression', async (t) => {
    ...
    const server = http_1.default.createServer((req, res) => {
        ...
        if (req.headers['accept-encoding'] === 'gzip') {
            ...
            const stream = stream_1.Readable.from([JSON.stringify(wanted)]);
            stream.pipe((0, zlib_1.createGzip)()).pipe(res);
        }
        else {
            res.writeHead(200, {
                'content-type': 'application/json',
...
(0, ava_1.default)('Should be able to decode deflate compression', async (t) => {
    ...
    const server = http_1.default.createServer((req, res) => {
        ...
        if (req.headers['accept-encoding'] === 'deflate') {
            ...
            const stream = stream_1.Readable.from([JSON.stringify(wanted)]);
            stream.pipe((0, zlib_1.createDeflate)()).pipe(res);
        }
        else {
            res.writeHead(200, {
                'content-type': 'application/json',
...
(0, ava_1.default)('Should be able to decode brotli compression', async (t) => {
    ...
    const server = http_1.default.createServer((req, res) => {
        ...
        if (req.headers['accept-encoding'] === 'br') {
            ...
            const stream = stream_1.Readable.from([JSON.stringify(wanted)]);
            stream.pipe((0, zlib_1.createBrotliCompress)()).pipe(res);
        }
        else {
            res.writeHead(200, {
                'content-type': 'application/json',
...
function getBaseUrlOf(server) {
    var _a;
    return `http://localhost:${(_a = server.address()) === null || _a === void 0 ? void 0 : _a.port}`;
}
